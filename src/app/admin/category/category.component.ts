...
if(this.fileData===null){
  this.data.createCategory(this.categoryForm.value).subscribe((data)=>{
this.getCategories();
...
this.fileData=null;
  ...
  this.imageServise.uploadFile('images', this.fileData.name, this.fileData).then((data => {
    ...
    category.img = data;
    this.data.createCategory(category).subscribe((data)=>{
      this.getCategories();
      this.categoryForm.reset();
      this.fileData = null;
    });
...
saveChanges(){
  this.data.editCategory(this.editIndex, this.categoryForm.value).subscribe(()=>{
    this.getCategories();
    this.isEdit=false;
    this.categoryForm.reset()
  })
